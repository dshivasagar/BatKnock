...
export default function HomeScreen({ navigation }) {
  ...
  const guideSteps = [
    {
      num: "1",
      text: "Oil the bat face, edges and back with raw linseed oil. Let it soak for 24 hours.",
    },
    {
      num: "2",
      text: "Use a knocking mallet to gently tap the edges at 45° to round them.",
    },
    {
      num: "3",
      text: "Work the face inward from edges, gradually increasing force over sessions.",
    },
    { num: "4", text: "After 2–3 sessions, test against an old leather ball." },
    {
      num: "5",
      text: "Repeat oiling and knocking 4–6 times before using in a match.",
    },
  ];
  ...
  const chooseBatSteps = [
    {
      num: "1",
      icon: "📏",
      title: "Get the Size Right First",
    ...
    },
    {
      num: "4",
      icon: "🌿",
      title: "English vs Kashmir Willow",
    ...
    },
    {
      num: "5",
      icon: "🏏",
      title: "Bat Profile — Power vs Control",
  ...
  const howToUseSteps = [
    {
      icon: "🏏",
      text: "Add a new bat with all the necessary info — brand, willow type, size, weight, grain count and your knocking target.",
    },
    {
      icon: "📐",
      text: "Define zone boundaries on the Heatmap screen so knock tracking maps accurately to your bat\u2019s actual photo.",
    },
    {
      icon: "🛢️",
      text: "Move to the Bat Preparation Journey — start with Oiling, then knocking.",
    },
    {
      icon: "🔨",
      text: "Cover all areas of the bat with the right knocking force for that phase, so the willow compresses evenly across the whole blade.",
    },
    {
      icon: "✅",
      text: "Once complete, the Heatmap will show you whether the bat is ready.",
    },
    {
      icon: "🔄",
      text: "Repeat the process based on the age and type of wood — older bats or different willow grades may need extra rounds for the best result.",
    },
  ];
      ...
      >
        ...
        {(weather || weatherLoading) && (
          <View style={{ marginHorizontal: 16, marginBottom: 16 }}>
            ...
            >
              {weatherLoading ? (
                <Text style={{ color: theme.textMuted, fontSize: F.sm }}>
                  Loading weather…
                </Text>
              ) : weather ? (
                <>
          ...
          <View style={{ flexDirection: "row", gap: 10 }}>
            {[
              ...
              <GradientCard
                ...
                style={{ flex: 1 }}
                onPress={() => {
                  if (item.action === "chooseguide") {
                    setChooseCardIndex(0);
                    setShowChooseGuide(true);
                  } else navigation.navigate(item.screen);
                }}
              >
                <View
                  style={{ paddingVertical: 18, alignItems: "center", gap: 8 }}
                >
                  <View
                    style={{
                      width: 48,
        ...
        <View style={{ paddingHorizontal: 16, marginBottom: 16 }}>
          ...
          >
            ...
            <Text style={{ color: "#fff", fontSize: F.md, fontWeight: "700" }}>
              Add New Bat
            </Text>
          </TouchableOpacity>
        </View>
                ...
                <GradientCard
                  ...
                  onPress={() => {
                    if (item.action === "guide") {
                      setCardIndex(0);
                      setShowKnockGuide(true);
                    } else if (item.action === "chooseguide") {
                      setChooseCardIndex(0);
                      setShowChooseGuide(true);
                    } else navigation.navigate(item.screen);
                  }}
        ...
        <View style={{ paddingHorizontal: 16, marginBottom: 16 }}>
          <GradientCard
            onPress={() => setShowHowToUse((s) => !s)}
            style={{
              borderBottomLeftRadius: showHowToUse ? 0 : 20,
              borderBottomRightRadius: showHowToUse ? 0 : 20,
            }}
          >
            <View
              style={{
          ...
          {showHowToUse && (
            ...
            >
              ...
              >
                ...
                >
                  Note: Knockmate is for guidance purposes only. Real-world
                  readiness can vary based on your own knocking technique and
                  the quality of the willow — use these tools as a helpful
        ...
        <View style={{ paddingHorizontal: 16, marginBottom: 16 }}>
          <GradientCard
            onPress={() => setShowLinksSection((s) => !s)}
            style={{
              borderBottomLeftRadius: showLinksSection ? 0 : 20,
              borderBottomRightRadius: showLinksSection ? 0 : 20,
            }}
          >
            <View
              style={{
            ...
            >
              {[
                ...
                >
                  ...
                  <Text style={{ color: theme.textMuted, fontSize: F.lg }}>
                    ›
                  </Text>
                </TouchableOpacity>
              ))}
          ...
          >
            ...
            >
              {guideSteps.map((_, i) => (
                <TouchableOpacity key={i} onPress={() => setCardIndex(i)}>
                  <View
                    style={{
                      width: cardIndex === i ? 24 : 8,
                      height: 8,
                      borderRadius: 4,
                      backgroundColor:
                        cardIndex === i ? theme.accent : theme.border,
                    }}
                  />
                </TouchableOpacity>
              ))}
            ...
            <View style={{ flexDirection: "row", gap: 12, marginTop: 20 }}>
              ...
              {cardIndex < guideSteps.length - 1 ? (
                <TouchableOpacity
                  onPress={() =>
                    setCardIndex((i) => Math.min(guideSteps.length - 1, i + 1))
                  }
                  style={{
                    flex: 1,
                    padding: 16,
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text
              style={{ color: theme.textSub, fontSize: 12, marginBottom: 20 }}
            >
            ...
            >
              {chooseBatSteps.map((_, i) => (
                <TouchableOpacity key={i} onPress={() => setChooseCardIndex(i)}>
                  <View
                    style={{
                      width: chooseCardIndex === i ? 24 : 8,
                      height: 8,
                      borderRadius: 4,
                      backgroundColor:
                        chooseCardIndex === i ? theme.accent : theme.border,
                    }}
                  />
                </TouchableOpacity>
              ))}
            ...
            <View style={{ flexDirection: "row", gap: 12, marginTop: 20 }}>
              ...
              {chooseCardIndex < chooseBatSteps.length - 1 ? (
                <TouchableOpacity
                  onPress={() =>
                    setChooseCardIndex((i) =>
                      Math.min(chooseBatSteps.length - 1, i + 1),
                    )
                  }
                  style={{
                    flex: 1,
                  ...
                  {[
                    ...
                    <TouchableOpacity
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        backgroundColor:
                          mode === t.key ? theme.accentDim : theme.bgInput,
                        borderWidth: 1.5,
                        borderColor:
                          mode === t.key ? theme.accent : theme.border,
                      }}
                    >
                      <Text style={{ fontSize: 20 }}>{t.icon}</Text>
                      <Text
                        style={{
                          color: mode === t.key ? theme.accent : theme.textSub,
                          fontSize: 11,
                          fontWeight: "700",
                          marginTop: 6,
                        }}
                  ...
                  {[
                    ...
                    <TouchableOpacity
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        backgroundColor:
                          fontScale === f.key ? theme.accentDim : theme.bgInput,
                        borderWidth: 1.5,
                        borderColor:
                          fontScale === f.key ? theme.accent : theme.border,
                      }}
                    >
                      <Text
                        style={{
                          color:
                            fontScale === f.key ? theme.accent : theme.textSub,
                          fontSize: f.size,
                          fontWeight: "800",
                        }}
                      >
                  ...
                  <View style={{ marginBottom: 24 }}>
                    ...
                    >
                      ...
                      >
                        ...
                        Set DEV_MODE = false in HomeScreen.js before submitting
                        to stores.
                      </Text>
                      <TouchableOpacity
                        onPress={() => activatePro()}
